 ...
 */
package echo.app.authmanager.data.ds.local

import echo.app.authmanager.data.db.AccountDao
...
class AccountLocalDataSourceImpl @Inject constructor(
    ...
    override suspend fun addSession(id: String, sessionId: String) {
        accountDao.addSession(id, sessionId)
    }
